...
export const inputControlClassCompact =
  "rounded-lg border border-slate-200 bg-white px-2 py-1 text-base sm:text-sm text-slate-700 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-300 dark:border-slate-500 dark:bg-slate-900/90 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:ring-slate-500";
