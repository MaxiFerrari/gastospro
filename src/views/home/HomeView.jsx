...
import { useHomeData } from "@views/home/hooks/useHomeData";
...
export default function HomeView({ userId }) {
  ...
  return (
    <div className="mx-auto w-full space-y-4 pb-4 sm:space-y-6 lg:max-w-none">
      {lowStock.length > 0 && (
        <div className="app-hub-inset flex items-start gap-3 p-4 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200/60 dark:border-amber-800/40 sm:mx-0">
      ...
      <div className="lg:grid lg:grid-cols-12 lg:items-start lg:gap-6">
        <div className="lg:col-span-8">
          <section className="app-hub-inset bg-white dark:bg-slate-800 rounded-2xl p-5 shadow-sm sm:mx-0 lg:min-h-[calc(100dvh-var(--app-nav-height)-10rem)]">
