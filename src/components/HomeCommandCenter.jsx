          ...
          <ul className="space-y-2">
            {topTasks.map((t) => (
              ...
              >
                ...
                <span className="text-xs text-slate-400 shrink-0">{t.assignee}</span>
              </li>
            ))}
          </ul>
